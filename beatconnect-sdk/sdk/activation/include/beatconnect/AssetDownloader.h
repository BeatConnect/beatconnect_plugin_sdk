...
// ==============================================================================
// Package Downloader (Higher-level API)
// ==============================================================================

/**
 * Download all assets from a purchased package.
 * Handles:
 * - Getting asset list from package
 * - Requesting presigned URLs
 * - Downloading all files
 * - Organizing into appropriate folders
 */
...
public:
    struct PackageInfo {
        ...
        std::string name;
        std::string type;          // "samplepack", "plugin", "bundle"
    ...
    /**
     * Configure with same options as AssetDownloader.
     */
    void configure(const DownloaderConfig& config);

    /**
     * Get info about a package including all its assets.
     */
    std::optional<PackageInfo> getPackageInfo(const std::string& packageId);

    /**
     * Download all assets from a package.
     */
    ...
    /**
     * Check if all assets from a package are downloaded.
     */
